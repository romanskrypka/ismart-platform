...
import { ArrowRight, BookOpen, Cpu, Database, Code2, Wrench } from 'lucide-react';

const moduleIcons = [BookOpen, Cpu, Database, Code2, Wrench];
        ...
        <div className="container relative pt-20 pb-16 md:pt-28 md:pb-24">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl font-light">
              От фундаментальных концепций до практического развёртывания локальных LLM, RAG-систем, Text-to-SQL и файн-тюнинга моделей.
            </p>
          </motion.div>
          ...
          >
            {[
              { value: '5', label: 'Модулей' },
              { value: '40+', label: 'Разделов' },
              { value: '10', label: 'Квизов' },
