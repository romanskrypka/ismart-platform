...
## Часть 16: Управление состоянием проекта между сессиями

При работе над большими проектами в Cursor критически важно сохранять контекст между сессиями. Подробное руководство описывает, как перейти от ручных "миграционных промптов" к автоматизированной системе из трёх файлов: `PROJECT_STATE.md` (единственный источник правды), `SESSION_LOG.md` (журнал изменений) и `DECISIONS.md` (архитектурные решения).

Подробнее: [`state_management_guide.md`](state_management_guide.md)
